	...
	public partial class WpfOpenGLControl : UserControl
	{
		...
		public WpfOpenGLControl()
		{
			...
			if (!DesignerProperties.GetIsInDesignMode(this))
			{
				...
				// for mouse testing
				glControl.MouseDown += Global.orb.Control_MouseDownEvent;
				glControl.MouseUp += Global.orb.Control_MouseUpEvent;
				glControl.MouseWheel += Global.orb.Control_MouseWheelEvent;
				// 
		...
		/// </summary>
		public event EventHandler GlRender_wpf;
