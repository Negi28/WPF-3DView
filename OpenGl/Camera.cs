...
namespace WpfOpenGlControl
{
    ...
    public class Camera
    {
        ...
        public Camera(Vector3 position, float aspectRatio)
        {
            ...
            //_front = (Position - target); _front.Normalize();
            //_right = Vector3.Cross(up1, _front); _right.Normalize();
            //_up = Vector3.Cross(_front, _right); _up.Normalize();
        }
        ...
        public Matrix4 GetProjectionMatrix()
        {
            ...
            return Matrix4.CreateOrthographicOffCenter(-2.0f, 2.0f, -2.0f, 2.0f, 0.001f, 6.0f);
        }
